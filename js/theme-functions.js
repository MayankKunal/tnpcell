    ...
    INSPIRO.masonryIsotope = function () {
        ...
        $isotops.each(function () {
            ...
            $menu.length && $menu.find("li:not('.link-only')").on("click", function (e) {
                ...
                document.getElementsByClassName('pastclass')[0].style.display = "none";
                document.getElementsByClassName('heading-center')[1].style.display = "none";
                document.getElementsByClassName('isotope portfolio-items')[1].style.display = "none";
